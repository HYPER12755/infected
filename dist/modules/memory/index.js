...
import { KnowledgeGraphManager, ensureMemoryFilePath, EntitySchema, RelationSchema } from './memory-core.js'; // Import from new memory-core.ts
...
function createZodToolHandler(schema, handler) {
    return async (rawArgs, _extra) => {
