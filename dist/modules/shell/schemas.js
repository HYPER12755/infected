import { z } from 'zod';
import { ExecutionModeSchema, ShellTypeSchema, ProcessSignalSchema, OutputTypeSchema, SecurityModeSchema, DimensionsSchema, EnvironmentVariablesSchema, } from '../../types/shell-server/index.js'; // Adapted import
// Shell Operations
export const ShellExecuteParamsSchema = z
    ...
    timeout_seconds: z
        ...
        .max(3600)
        .default(60)
        .describe('Maximum time in seconds to wait for foreground execution before switching to background or failing. Range: 1-3600 seconds.'),
    foreground_timeout_seconds: z
        ...
        .max(480)
        .default(480)
        .describe('For adaptive mode: timeout in seconds for the initial foreground phase before switching to background execution. Range: 1-300 seconds (maximum 300). If you need a longer timeout, use execution_mode "background" or "adaptive". Values above 300 will be rejected.'),
