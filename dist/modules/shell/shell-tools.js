...
export class ShellTools {
    ...
    async terminalOperate(params) {
        try {
            const shouldStripAnsi = params.strip_ansi !== undefined ? params.strip_ansi : !(params.include_ansi ?? false);
            ...
            if (!terminalId) {
                ...
                if (typeof inputToSend === 'string' && inputToSend.length > 0) {
                    ...
                    if (!effectiveForceInput) {
                        ...
                        includeAnsiInOutput, false // include_foreground_process
                        );
            ...
            if (params.get_output !== false) {
                ...
                params.output_lines || 20, includeAnsiInOutput, false // include_foreground_process
                );
                output = outputResult;
            }
            // 4. レスポンス構築
