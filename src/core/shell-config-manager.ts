 ...
 */
export class McpShellConfigManager { // Class name unchanged as per previous instruction
...
let globalMcpShellConfigManager: McpShellConfigManager | null = null; // Renamed global instance

/**
 * Get global configuration manager instance
 */
export function getGlobalMcpShellConfigManager(configPath?: string): McpShellConfigManager { // Renamed export function
