...
/**
 * Configuration specific to detached strategy
 */
export interface DetachedStrategyConfig extends ExecutionStrategyConfig {
 ...
 * ```
 */
export class DetachedStrategy extends ExecutionStrategy<DetachedStrategyConfig, StrategyExecutionResult> {
  private childProcess?: ChildProcess;

  constructor(config: DetachedStrategyConfig) {
    super(config);
    this.config = {
      shellPath: '/bin/bash',
      ...config,
   ...
   */
  async cleanup(childProcess?: ChildProcess): Promise<void> {
