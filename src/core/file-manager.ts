...
import { FileInfo, OutputType } from '../types/shell-server/index.js'; // Adapted import to shell-server types
import {
  generateId,
  getCurrentTimestamp,
} from '../utils/shell-helpers.js'; // Adapted import to shell-helpers
